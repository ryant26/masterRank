export const SIGN_IN = 'googleAnalytic/SIGN_IN';
export const CLICK_CONSOLE_USER_SEARCH = 'googleAnalytic/CLICK_CONSOLE_USER_SEARCH';
export const AUTHENTICATION_SUCCESSFUL = 'googleAnalytic/AUTHENTICATION_SUCCESSFUL';
...
export const VIEW_PLAYER_STATS = 'googleAnalytic/VIEW_PLAYER_STATS';
...
export const SYNC_CLIENT_AND_SERVER_HEROES_COMPLETE = 'googleAnalytic/SYNC_CLIENT_AND_SERVER_HEROES_COMPLETE';
export const UPDATE_PREFERRED_HEROES = 'googleAnalytic/UPDATE_PREFERRED_HEROES';

export const SOCKET_DISCONNECT = 'googleAnalytic/SOCKET_DISCONNECT';
